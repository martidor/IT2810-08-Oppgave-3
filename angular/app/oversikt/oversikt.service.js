...
var OversiktService = (function () {
    function OversiktService(http) {
        this.http = http;
        this.url = './../../dummy-funds.json'; // URL to JSON
    }
    OversiktService.prototype.getRows = function () {
        return this.http.get(this.url)
            .map(this.extractData)
            .catch(this.handleError);
    };
    OversiktService.prototype.extractData = function (res) {
        var body = res.json();
        return body;
    };
    OversiktService.prototype.handleError = function (error) {
